      ...
      <div className="flex-1 space-y-2 sm:space-y-3 min-w-0 flex flex-col">
        <div className="flex items-start gap-2">
          {is_veg !== undefined && is_veg !== null && (
            <div
              className={`flex-shrink-0 w-3.5 h-3.5 mt-1 sm:mt-1.5 border ${is_veg ? "border-green-500" : "border-red-500"} flex items-center justify-center rounded-sm`}
            >
              <div
                className={`w-1.5 h-1.5 ${is_veg ? "bg-green-500" : "bg-red-500"} rounded-full`}
              ></div>
            </div>
          )}
