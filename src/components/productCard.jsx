...
const ProductCard = ({
  ...
  const displayCuisines = Array.isArray(cuisines)
    ? cuisines.join(", ")
    : cuisines || "Delicious Choice";

  return (
    <div
      className={`group h-full  flex flex-col bg-white transition-all duration-300 ${!is_active ? "opacity-60 grayscale pointer-events-none" : ""}`}
    >
